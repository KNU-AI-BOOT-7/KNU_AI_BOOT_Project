...
실행:
    .venv/bin/python -m backend.app.train_transformer                    # 기본 KoELECTRA
    MODEL=klue/bert-base .venv/bin/python -m backend.app.train_transformer
